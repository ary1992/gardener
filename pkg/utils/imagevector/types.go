...
const (
	...
	// ImagePullCredentialTypeKubeletCredentialProvider uses a kubelet credential provider plugin on the node.
	ImagePullCredentialTypeKubeletCredentialProvider ImagePullCredentialType = "KubeletCredentialProvider"
)
...
type ImagePullCredential struct {
	...
	// TODO: add KubeletCredentialProvider fields in follow-up PR.
}
