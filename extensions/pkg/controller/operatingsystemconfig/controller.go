...
func add(mgr manager.Manager, options controller.Options, predicates []predicate.Predicate) error {
	...
	return ctrl.Watch(source.Kind(mgr.GetCache(), &extensionsv1alpha1.OperatingSystemConfig{}, &handler.TypedEnqueueRequestForObject[*extensionsv1alpha1.OperatingSystemConfig]{}, predicates...))
}
